...
class TestTeamEndpoints:
    ...
    def test_heuristic_breakdown_function(self):
        ...
        from src.fpl_toolkit.service.team_endpoints import _simple_minutes_projection, _simple_event_breakdown_for_projection
        ...
        breakdown = _simple_event_breakdown_for_projection(8.5, player_data, 90)
    ...
    def test_position_specific_weights(self):
        ...
        from src.fpl_toolkit.service.team_endpoints import _simple_event_breakdown_for_projection
        
        # Test goalkeeper vs forward
        gk_data = {"element_type": 1, "form": "5.0"}  # GK
        fwd_data = {"element_type": 4, "form": "5.0"}  # FWD
        
        gk_breakdown = _simple_event_breakdown_for_projection(8.0, gk_data, 90)
        fwd_breakdown = _simple_event_breakdown_for_projection(8.0, fwd_data, 90)
    ...
    def test_enhanced_breakdown_integration(self):
        """Test that enhanced breakdown works with advanced metrics."""
        from src.fpl_toolkit.analysis.advanced_metrics import enhance_breakdown_with_advanced_metrics, _simple_event_breakdown
        
        # Create a base breakdown
        player_data = {"element_type": 3, "form": "5.0"}
        base_breakdown = _simple_event_breakdown(8.0, player_data, 90)
        
        # Enhance it
        enhanced = enhance_breakdown_with_advanced_metrics(base_breakdown, player_data, 8.0)
        
        # Should have adjustments section if advanced metrics are available
        assert "total" in enhanced, "Enhanced breakdown should preserve total"
        
        # Enhanced breakdown should include advanced metrics when available
        if "adjustments" in enhanced:
            assert isinstance(enhanced["adjustments"], dict), "Adjustments should be a dict"
...
if __name__ == "__main__":
    ...
    test_instance.test_enhanced_breakdown_integration()
